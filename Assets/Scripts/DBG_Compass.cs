...
public class DBG_Compass : MonoBehaviour
{
    ...
    protected void OnGUI()
    {
        ...
        GUILayout.Label("input.gyro.attitude: " + Input.gyro.attitude.ToString() + "|" + Input.gyro.attitude.eulerAngles.ToString("0.00"));
